...
set_property PACKAGE_PIN V14 [get_ports {key[5]}]
set_property PACKAGE_PIN T16 [get_ports {key[3]}]
set_property PACKAGE_PIN V15 [get_ports {key[4]}]
set_property PACKAGE_PIN U14 [get_ports {key[2]}]
set_property PACKAGE_PIN T15 [get_ports {key[1]}]
set_property PACKAGE_PIN V16 [get_ports {key[0]}]
