...
#
# Generated by export_simulation on Tue Oct 31 15:05:29 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './myclk_wiz.sh' script.

./myclk_wiz.sh -reset_run
...
./myclk_wiz.sh -noclean_files

For more information on the script, please type './myclk_wiz.sh -help'.
